...
export interface UnitEventBus {
	...
	on(
		type: UnitEventTypes.ACTION_ADDED,
		listener: (action: PipelineStageUnitAction, unit: PipelineStageUnit) => void
	): this;
	...
	on(
		type: UnitEventTypes.ACTION_REMOVED,
		listener: (action: PipelineStageUnitAction, unit: PipelineStageUnit) => void
	): this;
	...
	on(
		type: UnitEventTypes.ACTION_CHANGED,
		listener: (action: PipelineStageUnitAction, unit: PipelineStageUnit) => void
	): this;
