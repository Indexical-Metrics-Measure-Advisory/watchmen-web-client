...
const AllTypeOptions: { [key in FactorType]: { label: string, order: number } } = {
	...
	[FactorType.SEASON]: { label: En.FACTOR.SEASON, order: 10408 },
	[FactorType.MONTH]: { label: En.FACTOR.MONTH, order: 10409 },
	[FactorType.HALF_MONTH]: { label: En.FACTOR.HALF_MONTH, order: 10410 },
	[FactorType.TEN_DAYS]: { label: En.FACTOR.TEN_DAYS, order: 10411 },
	[FactorType.WEEK_OF_YEAR]: { label: En.FACTOR.WEEK_OF_YEAR, order: 10412 },
	[FactorType.WEEK_OF_MONTH]: { label: En.FACTOR.WEEK_OF_MONTH, order: 10413 },
	[FactorType.HALF_WEEK]: { label: En.FACTOR.HALF_WEEK, order: 10414 },
	[FactorType.DAY_OF_MONTH]: { label: En.FACTOR.DAY_OF_MONTH, order: 10415 },
	[FactorType.DAY_OF_WEEK]: { label: En.FACTOR.DAY_OF_WEEK, order: 10416 },
	[FactorType.DAY_KIND]: { label: En.FACTOR.DAY_KIND, order: 10417 },
	[FactorType.HOUR]: { label: En.FACTOR.HOUR, order: 10418 },
	[FactorType.HOUR_KIND]: { label: En.FACTOR.HOUR_KIND, order: 10419 },
	[FactorType.MINUTE]: { label: En.FACTOR.MINUTE, order: 10420 },
	[FactorType.SECOND]: { label: En.FACTOR.SECOND, order: 10421 },
	[FactorType.MILLISECOND]: { label: En.FACTOR.MILLISECOND, order: 10422 },
	[FactorType.AM_PM]: { label: En.FACTOR.AM_PM, order: 10423 },
