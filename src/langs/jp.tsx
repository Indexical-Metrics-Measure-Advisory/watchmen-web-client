...
export const Jp = {
	...
	CHART: {
		...
		SECTION_TITLE_COLOR: 'カラーレンダリング',
		SECTION_TITLE_BORDER: 'ボーダーレンダリング',
		SECTION_TITLE_FONT: 'フォント',
		SECTION_TITLE_POSITION: '位置',
		SECTION_TITLE_PADDING: 'パディング',
		SECTION_TITLE_GAP_AND_PADDING: 'ギャップとパディング',
		...
		SERIES_TEXT_COLOR: 'シリーズテキスト - カラーレンダリング',
		SERIES_TEXT_BORDER: 'シリーズテキスト - ボーダーレンダリング',
		SERIES_TEXT_GAP_AND_PADDING: 'シリーズテキスト - ギャップとパディング',
		LEGEND_ORIENT: '方向',
