...
`;
export const ComputedEditBodyContainer = styled.div.attrs({ 'data-widget': 'parameter-computed-body' })`
	display                    : grid;
	position                   : relative;
	...
	padding-left               : 1px;
`;
export const ParameterEditContainer = styled.div.attrs<{ shorten: boolean }>(({ shorten }) => {
	return {
