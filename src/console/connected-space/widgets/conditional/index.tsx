...
export const ConditionalEditor = (props: {
	...
	const {conditional, availableTopics, pickedTopics, onChange, force = false} = props;
	...
	return <ConditionalEventBusProvider>
		...
		<JointEventBusProvider>
			...
			<ConditionalContainer>
				...
				<TopJoint conditional={conditional} availableTopics={availableTopics} pickedTopics={pickedTopics}/>
			</ConditionalContainer>
		</JointEventBusProvider>
